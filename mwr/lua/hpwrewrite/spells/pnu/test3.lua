...
function Spell:OnFire(wand)
	...
	local function CallIonEffects()
		...
		util_Effect("pc_ion_cannon", effectdata)
		util_Effect("pc_ion_cannon_particle", effectdata)
		util_Effect("pc_ion_cannon_particle2", effectdata)

	end

	CallIonEffects()
	timer.Simple(0.05, CallIonEffects)
	timer.Simple(0.15, CallIonEffects)
...
HpwRewrite:AddSpell("Ion Beam", Spell)